...
o dynamic array of objects | heap allocator / 'deallocator for no-memory leak' 
*/
...
int main() {
	...
	RectangleEntity* rectangles = nullptr;
	rectangles = new RectangleEntity[numberOfRectanges];
