...
Learning outcome
o friend class	| each member function of friend class can access the private members of the class 
*/
...
public:
	/*
	friend void RectangleService::readRect(RectangleEntity& rectangle);
	friend void RectangleService::printRect(const RectangleEntity& rectangle);
	friend int RectangleService::findArea(const RectangleEntity& rectangle);
	friend int RectangleService::findCircumference(const RectangleEntity& rectangle);
	*/
	friend RectangleService;
};
